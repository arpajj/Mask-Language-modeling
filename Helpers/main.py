...
tokens_of_interest = ["true", "yes", "right", "false", "no", "wrong", "unknown", "maybe", "neutral"]

# positive tokens: true, yes, right
# negative tokens: false, no, wrong
# neutral tokens: unknown, maybe, neutral

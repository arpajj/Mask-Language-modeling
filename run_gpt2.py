...
def valid(dataset_name, tokenizer, model, START):
    ...
    return all_predicts, golden, accs, skip_num

def test(dataset_name, tokenizer, model, skip_num, tag="test"):
    """
...
if __name__ == '__main__':
    ...
    test_predicts, test_golden = test(dataset_name, tokenizer, model, skip_num, tag="valid")
